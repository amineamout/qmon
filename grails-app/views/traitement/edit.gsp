...
<html>
	...
	<body>
		<a href="#edit-traitement" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-traitement" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${traitementInstance?.version}" />
				<fieldset class="form">
